...
const About = () => {
   ...
   const description = (
      <Text
         ...
         text="Task Manager: Your simple solution for getting things done! Ideal for professionals, students, or anyone aiming for a clutter-free day. Organize tasks easily into 'Todo,' 'Completed,' and 'Ongoing.' Effortlessly create, edit, and delete tasks. Dive into details to track progress and see time remaining. Simplify your day, stay organized, and boost productivity with Task Manager."
      />
   );
